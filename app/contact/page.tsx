...
export default function ContactPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0a0a0a] text-white">
      ...
      {/* Background — same as Samsung/Voltas/Services */}
      ...
      {/* HERO — keeps existing banner image, matches page hero style */}
      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-10 pb-16 sm:pb-24 lg:pb-32">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          {/* LEFT — Contact info card, styled like the Solutions/Services cards */}
          <Reveal>
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-2xl sm:rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 lg:p-10 h-full"
            >
              ...
              <h2 className="text-2xl sm:text-3xl font-semibold leading-tight mb-8 sm:mb-10">
                Let&#39;s Build Better<br />Cooling Solutions
              </h2>

              {/* Contact items — styled like service list rows */}
              <div className="space-y-0">

                {[
                  {
                    label: "Office Address",
                    value: "Building No-53, 865/E-4, Second Floor, 7th Lane, Junior Janatha Road, Vytilla. Ernakulam - 682019, Kerala, India.",
                    ...
                    icon: (
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657 13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
